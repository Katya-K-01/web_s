...
@app.route('/recipe1')
def recipe1():
    return render_template('rec1.html', menu=dbase.getMenu(), title='Рецепт 1')

@app.route('/recipe2')
def recipe2():
    return render_template('rec2.html', menu=dbase.getMenu(), title='Рецепт 2')

@app.route('/recipe3')
def recipe3():
    return render_template('rec3.html', menu=dbase.getMenu(), title='Рецепт 3')
